...
const demoProposals: DemoProposal[] = [
  ...
  // Buffet
  {
    ...
    included: ["Cardápio personalizado", "Preparo dos alimentos", "Equipe de apoio", "Montagem da mesa", "Atendimento durante o evento"],
    notes: "Buffet personalizado com cardápio definido em reunião prévia, equipe treinada e apresentação impecável.",
    status: "sent",
    viewCount: 3,
    nicheLabel: "buffet-aniversario",
  },
